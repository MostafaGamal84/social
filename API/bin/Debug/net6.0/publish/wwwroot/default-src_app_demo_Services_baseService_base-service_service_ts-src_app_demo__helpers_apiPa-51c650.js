"use strict";
(self["webpackChunkng_able_pro"] = self["webpackChunkng_able_pro"] || []).push([["default-src_app_demo_Services_baseService_base-service_service_ts-src_app_demo__helpers_apiPa-51c650"],{

/***/ 90202:
/*!*******************************************************************!*\
  !*** ./src/app/demo/Services/baseService/base-service.service.ts ***!
  \*******************************************************************/
...
/* harmony export */ });
class BaseService {
    constructor(httpService, path) {
        this.httpService = httpService;
        this.path = path;
        this.endPoint = path;
    }
    GetAll() {
        return this.httpService.httpGet(this.endPoint);
    }
    GetByManagerId() {
        return this.httpService.httpGet(this.endPoint + 'GetByManagerId');
    }
    GetByTeacherId() {
        return this.httpService.httpGet(this.endPoint + 'GetByTeacherId');
    }
    GetByStudentId() {
        return this.httpService.httpGet(this.endPoint + 'GetByStudentId');
    }
    GetById(id) {
        return this.httpService.httpGet(this.endPoint + id);
    }
    Add(model) {
        return this.httpService.httpPost(this.endPoint + 'add', model);
    }
    Update(model) {
        return this.httpService.HttpPost(this.endPoint + 'update', model);
    }
    UpdateSubscribe(id) {
        return this.httpService.HttpPost(this.endPoint + 'updateSubscribe/' + id);
    }
    Delete(id) {
        return this.httpService.httpDelete(this.endPoint + id);
    }
    restore(id) {
        return this.httpService.HttpPost(this.endPoint + 'restore/' + id);
    }
    GetDeleted() {
        return this.httpService.httpGet(this.endPoint + 'GetDeleted');
    }
}
...
/***/ 89778:
/*!******************************************!*\
  !*** ./src/app/demo/_helpers/apiPath.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ApiPath;
(function (ApiPath) {
    ApiPath["Nationality"] = "Nationality/";
    ApiPath["Governorate"] = "Governorate/";
    ApiPath["Subscribe"] = "Subscribe/";
    ApiPath["SubscribeType"] = "SubscribeType/";
    ApiPath["Student"] = "Student/";
    ApiPath["Family"] = "Family/";
    ApiPath["PayStatue"] = "PayStatue/";
    ApiPath["Circle"] = "Circle/";
    ApiPath["Teacher"] = "Teacher/";
    ApiPath["Manager"] = "Manager/";
    ApiPath["Time"] = "Time/";
    ApiPath["PayScreenShot"] = "PayScreenShot/";
    ApiPath["Quran"] = "Quran/";
    ApiPath["StudentReport"] = "StudentReport/";
    ApiPath["AttendStatue"] = "AttendStatue/";
})(ApiPath || (ApiPath = {}));
...
//# sourceMappingURL=default-src_app_demo_Services_baseService_base-service_service_ts-src_app_demo__helpers_apiPa-51c650.js.map